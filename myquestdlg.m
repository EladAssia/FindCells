function ButtonName=myquestdlg(Question,Title,Btns,Default)
...
if nargin <= 2
    error(message('MATLAB:questdlg:NotEnoughInputs'));
end
if nargin > 4
...
btnMargin=1.4;
for ii = 1:length(Btns)
    set(ExtControl,'String',Btns{ii});
